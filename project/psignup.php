...
<input type="text" name="name" placeholder="Unique Id">
    </div>
    <div class="input-box">
...
<input type="text" name="name" placeholder="Your Name">
    ...
    <div class="input-box">
      <span class="details">Covicted For </span>
<input type="text" name="name" placeholder="Covicted For">
    </div>
...
<br>
<a href="indexj.html">Home Page</a>
  </div>
</center>
  </body>
</html>
